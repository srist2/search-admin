...
public class ClaimController {
    ...
    public Result updateIsPass(@RequestBody Map params) {
        ...
        if (flag == 1) {
            ...
            ToEmail toEmail = initEmail(new String[]{email} , info.getInfoName(), info.getContactPerson().getCtPhone(),
                    info.getContactPerson().getCtEmail(), info.getContactPerson().getCtAddress());
            int flag2 = sendEmail(toEmail);
            if (flag2 == 1) {
     ...
     */
    public ToEmail initEmail(String[] fromEmail, String infoName, String CtPhone, String CtEmail, String CtAddress) {
        ToEmail toEmail = new ToEmail();
        // 邮件标题
        String subject = "您认领的失踪者" + infoName + "，审核通过了！";
        String content = "您认领的失踪者的联系人信息为：\n \t电话号码：" + CtPhone
                + "\n \t邮箱：" + CtEmail
                + "\n \t联系地址：" + CtAddress;
        // 接收人
